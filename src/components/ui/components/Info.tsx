        ...
        <>
            <div className='relative group/tooltip'>
                <div 
                    ...
                    className='fixed bottom-0 left-0 z-20 bg-teal-500 text-white rounded-tr-full p-4 shadow-md hover:cursor-pointer hover:scale-110 transition-all shiny-effect'
                >
