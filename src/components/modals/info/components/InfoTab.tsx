export const InfoTab = () => {
    return (
        <div className="max-w-4xl mx-auto p-4 text-left text-slate-500">
            ...
            <h4 className="text-md font-semibold mt-4 text-slate-600 dark:text-slate-400">Learn More</h4>
            <p className="mt-2">
                For more information about Visual Snow Syndrome, visit the <a href="https://www.visualsnowinitiative.org/visual-snow-syndrome/" className="text-blue-500 hover:text-blue-600">Visual Snow Initiative</a> website.
            </p>
        </div>
    )
}
