...
const fragmentShader = `void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
...
class EyeFloatersEffectClass extends Effect {
  constructor({ param = 0.1 } = {}) {
    super('Eye Floaters Effect', fragmentShader, {
      uniforms: new Map([
        ['u', new Uniform(param)],
    ]),
    })
...
// Effect component
export const EyeFloatersEffect = forwardRef(({ param }, ref) => {
